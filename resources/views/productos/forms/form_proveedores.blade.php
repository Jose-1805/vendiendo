            ...
            @if($accion == "create")
                <div id="proveedor-1" class="proveedores col s12">
                    ...
                    <div class="input-field col s12 l{{$lastColumns}}">
                        {!!Form::label("utilidad_1","Utilidad %",["class"=>"active"])!!}
                        {!!Form::text("utilidad_1",null,["id"=>"utilidad_1","class"=>"num-real utilidad","placeholder"=>"Ingrese la utilidad"])!!}
                    </div>
                    ...
                    <div class="input-field col s12 l{{$lastColumns}}">
                        {!!Form::label("precio_venta_1","Precio venta",["class"=>"active"])!!}
                        {!!Form::text("precio_venta_1",null,["id"=>"precio_venta_1","class"=>"num-real precio_venta","placeholder"=>"Ingrese el precio de venta al público"])!!}
                    </div>
                </div>
            @elseif($accion == 'edit')
                    ...
                    @foreach($detalle_producto as $obj)
                        <div id="proveedor-{{$aux}}" class="proveedores col s12">
                            ...
                            <div class="input-field col s12 l{{$lastColumns}}">
                                ...
                                {!!Form::text("utilidad_".$aux,$obj->utilidad_nueva,["id"=>"utilidad_".$aux,"class"=>"num-real utilidad","placeholder"=>"Ingrese la utilidad"])!!}
                            </div>
                            ...
                            <div class="input-field col s12 l{{$lastColumns}}">
                                ...
                                ?>
                                {!!Form::text("precio_venta_".$aux,$precio_venta,["id"=>"precio_venta_".$aux,"class"=>"num-real precio_venta","placeholder"=>"Ingrese el precio de venta al público"])!!}
                            </div>
                        </div>
                        <?php $aux++; ?>
                    @endforeach
