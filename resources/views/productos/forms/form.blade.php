...
if($producto->exists){
    ...
    if($producto->tipo_producto != "Terminado"){
        ...
        $precioV = round($precioV);
        $producto->utilidad = round($producto->utilidad);
    }
...
<div class="col s12" style="padding: 20px;">
    ...
    <div class="input-field col s12 m6">
        ...
        {!!Form::text("utilidad",null,["id"=>"utilidad","class"=>"num-real","placeholder"=>"Ingrese la utilidad","maxlength"=>"5"])!!}
    </div>
    <div class="input-field col s12 m6">
        {!!Form::label("precio_venta","Precio venta al público")!!}
        {!!Form::text("precio_venta",$precioV,["id"=>"precio_venta","class"=>"num-entero","placeholder"=>"Ingrese el precio de venta al público","maxlength"=>"100"])!!}
    </div>
    </div>
    ...
    @elseif($accion =='edit')
        @if($terminado !="")
            <div id="form-contenido">
                @include('productos.forms.form_proveedores',['accion'=>'edit'])
            </div>
        @else
            <div id="form-contenido">
                @include('productos.forms.form_materias_primas',['accion'=>'edit'])
            </div>
        @endif
    @endif
    @if($accion == "edit")
