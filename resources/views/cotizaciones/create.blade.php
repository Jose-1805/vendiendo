...
@section('contenido')
    <div class="col s12 {{$size_medium}} white padding-bottom-30" style="margin-top: 85px">
        <p class="titulo">Crear cotización</p>
            ...
            <div class="col s12 m10 offset-m1 margin-top-30" id="content-detalle-cotizacion" style="margin-top: -30px;">
                <div class="input-field row">
                    <div class="col s12 m5 l4">
                        {!! Form::text("dias_vencimiento",1,["id"=>"dias_vencimiento","class"=>"num-entero"]) !!}
                        {!! Form::label("dias_vencimiento","Días para vencimiento de la cotización",["class"=>"active"]) !!}
                    </div>
                </div>
                <p class="titulo-modal margin-top-20">Detalles de la cotización <i id="muestra_div" class="fa fa-low-vision hide" title="Muestra el recuadro con el valoe total de la cotización" aria-hidden="true" style="float:right;cursor: pointer; color:rgb(140, 189, 83); font-size:24px; " onclick="oculta_div_flotante();"></i></p>
                <div class="content-table-slide col s12">
                    @include('cotizaciones.detalle_cotizacion')
                    {!! Form::hidden("cliente",$data[3],["id"=>"cliente"]) !!}
                </div>

                <div class="col s12 input-field">
                    {!! Form::label("observaciones","Observaciones") !!}
                    {!! Form::textarea("observaciones",null,["id"=>"observaciones","class"=>"materialize-textarea"]) !!}
                </div>
                ...
                @if(\Illuminate\Support\Facades\Auth::user()->permitirFuncion("Crear","cotizaciones","inicio"))
                    <div class="col s12 center margin-top-40" id="" >
                        <a class="btn waves-effect waves-light blue-grey darken-2" onclick="guardarCotizacion();" >Guardar cotización</a>
                    </div>
                @endif
            </div>
    </div>
