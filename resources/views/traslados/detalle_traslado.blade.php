@include("templates.mensajes",["id_contenedor"=>"detalles-cotizacion"])
...
<table class="table highlight centered" style="min-width: 500px;" id="tabla-detalle-producto">
    ...
    <tr class="filaProductos" id="filaProd_0">
        <td>
            <input type="text" class="barcode" id="barCodeProducto" onchange="seleccionProducto('barCode', 'filaProd_0', this.id,event);"  placeholder="Codigo de barras">
        </td>
        <td>
...
<div class="contenedor-btn-add-elemento margin-bottom-50 right-align margin-top-20">
    <a href="#!" class="waves-effect waves-light blue-grey darken-2 btn" onclick="agregarElementoTraslado()" >Agregar Elemento</a>
