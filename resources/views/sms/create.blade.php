...
@section('contenido')
    <div class="col s12 {{$size_medium}} white padding-10" style="margin-top: 85px;" >
            <p class="titulo">Crear mensaje de texo</p>
            ...
            <div class="col s12" style="padding: 20px;">
                <?php
                    $nombre_negocio = \Illuminate\Support\Facades\Auth::user()->nombre_negocio;
                ?>
                {!! Form::open([ 'url' => 'sms/store/' ,'data-toggle'=>'validator', 'class' => 'form-inline','role'=> 'form','method' => 'POST', 'novalidate', 'id' => 'form-sms',  'autocomplete' =>'off'] ) !!}
                <div class="col s12" style="padding: 20px;">
                    <div class="input-field col s12 m6">
                        {!!Form::label("titulo","Nombre negocio")!!}
                        {!! Form::text("titulo",$nombre_negocio,["id"=>"titulo_sms","placeholder"=>"Ingrese el nombre del negocio","class"=>"validate active"]) !!}
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        {!! Form::textarea("mensaje",null,["id"=>"mensaje_sms","class"=>"materialize-textarea","placeholder"=>"Describa brevemente el mensaje","onkeyup"=>"validaCantidadCaracteres()"]) !!}
                    ...
                    <div class="col s12 center" id="contenedor-action-form-sms" style="margin-top: 30px;">
                        <a class="btn cyan waves-effect waves-light" id="btn-action-form-sms">Guardar</a>
                    </div>
