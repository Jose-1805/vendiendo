...
@section('contenido')
    <div class="col s12 {{$size_medium}} white padding-bottom-30" style="margin-top: 85px">
        <p class="titulo">Reporte de ventas por empleado</p>
            ...
            <div class="col s12">
                {!! Form::open(["id"=>"form-filtos-ventas-por-empleado"]) !!}
            ...
            @include("templates.mensajes",["id_contenedor"=>"ventas-por-empleado"])
            <div class="progress hide" id="progress-ventas-por-empleado"><div class="indeterminate"></div></div>
            <div class="divider col s12 margin-top-40"></div>
            <div class="col s12 content-table-slide scroll-style" id="contenedor-ventas-por-empleado">
            </div>
    </div>
@endsection
...
@section('js')
    @parent
    <script src="{{asset('js/reportes/ventas_por_empleado.js')}}"></script>
