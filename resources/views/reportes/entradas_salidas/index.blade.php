...
?>
@section('contenido')
    <div class="col s12 m10 offset-m1 white padding-bottom-30" style="margin-top: 85px">
        <p class="titulo">Reporte de movimiento de inventario</p>
        ...
        <div class="col s12">
            {!! Form::open(["id"=>"form-filtos-entradas-salidas"]) !!}
        ...
        @include("templates.mensajes",["id_contenedor"=>"entradas-salidas"])
        <div class="progress hide" id="progress-entradas-salidas"><div class="indeterminate"></div></div>
        <div class="divider col s12 margin-top-40"></div>
        <div class="col s12 content-table-slide scroll-style" id="contenedor-entradas-salidas">
        </div>
    </div>
@endsection
...
@section('js')
    @parent
    <script src="{{asset('js/reportes/entradas_salidas.js')}}"></script>
