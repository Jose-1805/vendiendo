...
@section('contenido')
    <div class="col s12 {{$size_medium}} white padding-bottom-30" style="margin-top: 85px">
        <p class="titulo">Reporte ventas</p>
            ...
            <div class="col s12">
                {!! Form::open(["id"=>"form-filtos-ventas"]) !!}
            ...
            @include("templates.mensajes",["id_contenedor"=>"ventas"])
            <div class="progress hide" id="progress-ventas"><div class="indeterminate"></div></div>
            <div class="divider col s12 margin-top-40"></div>
            <div class="col s12 content-table-slide" id="contenedor-ventas">
                <table class="table centered highlight " id="tabla_reporte_ventas">
                    <thead>
