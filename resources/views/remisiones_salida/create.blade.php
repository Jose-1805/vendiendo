...
@section('contenido')
    <div class="col s12 {{$size_medium}} white padding-bottom-30" style="margin-top: 85px">
        <p class="titulo">Crear remisión de salida</p>
        @include("templates.mensajes",["id_contenedor"=>"crear-remision-salida"])

        <div class="col s12 " id="contenedor-detalles-remision-salida" style="margin-top: 0px;">
            <p class="titulo-modal col s12 margin-top-10">Detalles de la remisión</p>
            <div class="content-table-slide col s12">
                @include("templates.mensajes",["id_contenedor"=>"detalles-remision-salida"])
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->permitirFuncion("Crear","Remision salida","inicio"))
                <div class="col s12 center margin-top-40" id="contenedor-boton-realizar-remision-salida">
                    <a class="btn waves-effect waves-light blue-grey darken-2" onclick="realizarRemision()" >Registrar remisión</a>
                </div>
            @endif
            <div class="progress hide" id="progress-remision-salida">
...
<div id="modal-elementos-remision-salida" class="modal modal-fixed-footer ">
    ...
    height: 25px;
        ...
        </button><span class="" id="titulo-modal-remisiones-salida">Productos</span></p>
        @include('templates.mensajes',["id_contenedor"=>"elementos-remision-salida"])
    ...
    <div class="modal-footer" id="div-footer-elementos-remision-salida">
        <div class="col s12" id="contenedor-botones-elementos-remision-salida-modal">
            <a class="green-text btn-flat" onclick="javascript: seleccionElemento('', 'modal_productos_remision_salida')">Aceptar</a>
            <a class="modal-close cyan-text btn-flat">Cancelar</a>
        </div>

        <div class="progress hide" id="progress-elementos-remision-salida-modal">
...
<div id="modal-edit-precio" class="modal modal-fixed-footer modal-small">
    <div class="modal-content">
        <p class="titulo-modal" id="titulo-modal-remisiones-salida">Editar valor del producto</p>
...
<div id="modal-edit-precio-materia-prima" class="modal modal-fixed-footer">
    <div class="modal-content">
        <p class="titulo-modal" id="titulo-modal-remisiones-salida">Editar valor de la materia prima</p>
        @include('templates.mensajes',["id_contenedor"=>"editar-valor-producto"])
