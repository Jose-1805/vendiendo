...
@section('contenido')
    <div class="col s12 {{$size_medium}} white" style="margin-top: 85px">
        <p class="titulo">Configuración de facturas</p>
        <div id="contenedor-lista-productos" class="col s12">
            ...
            <div class="col s12 grey lighten-3">
                <p class="font-small blue-text text-accent-2"><strong>Importante! </strong> La informacón que se registre no podrá ser editada nuevamente durante el proceso de configuración, cada factura debe pertenecer a un almacén.</p>
            </div>
            {!! Form::open(['id'=>'form-lista-facturas']) !!}
            <div id="lista-facturas" class="content-table-slide col s12">
                <table class="bordered highlight centered no-material-select" id="tabla_facturas">
                    <thead>
                    <tr>
                        <th>Número</th>
                        <th>Valor</th>
            ...
            <div class="col s12 padding-top-20 grey lighten-3">
                <div class="col s12 m6 l8 blue-text text-accent-2">
                    ...
                    para guardar la información seleccionada en la tabla de facturas
                    </p>
                </div>
...
@section('js')
    @parent
    <script src="{{asset('js/migracion_ab/facturas.js')}}"></script>
@endsection
